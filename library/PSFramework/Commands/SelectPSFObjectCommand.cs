...
namespace PSFramework.Commands
{
    ...
    /// </summary>
    [Cmdlet("Select", "PSFObject", DefaultParameterSetName = "DefaultParameter", RemotingCapability = RemotingCapability.None)]
    public class SelectPSFObjectCommand : PSCmdlet
    {
        #region Parameters
        /// <summary>
