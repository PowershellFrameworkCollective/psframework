...
namespace PSFramework.Message
{
    ...
    public class PsfException
    {
        ...
        /// </summary>
        public PsfException InnerException;
        ...
        public PsfException(Exception Except)
        {
            _Exception = Except;
            ...
            Data = Except.Data;
            if (Except.InnerException != null) { InnerException = new PsfException(Except.InnerException); }
        ...
        public PsfException(ErrorRecord Record)
        ...
        public PsfException(Exception Except, string FunctionName, DateTime Timestamp, string Message, Guid Runspace, string ComputerName)
            : this(Except)
        {
        ...
        /// <param name="Runspace">The ID of the runspace from which the exception was thrown. Useful in multi-runspace scenarios.</param>
        /// <param name="ComputerName">The computer the error occured on.</param>
        public PsfException(ErrorRecord Record, string FunctionName, DateTime Timestamp, string Message, Guid Runspace, string ComputerName)
            : this(Record)
        {
            this.Runspace = Runspace;
            this.ComputerName = ComputerName;
