...
namespace PSFramework.Message
{
    /*
    /// <summary>
    /// An error record written by the PowerShell Framework
    /// </summary>
    [Serializable]
    public class PsfErrorRecord
    {
        /// <summary>
        ...
        public PsfErrorRecord(ErrorRecord Record, string FunctionName, DateTime Timestamp, string Message, Guid Runspace)
        {
