...
namespace PSFramework.Parameter
{
    ...
    /// </summary>
    public class PathFileSystemLaxParameter : PathFileSystemParameterBase
    {
        #region Constructors
        /// <summary>
        ...
        public PathFileSystemLaxParameter(string Path)
        {
            InputObject = Path;
            foreach (string filePath in ResolveFileSystemPath(Path, true, true, false))
                AddEx(filePath);
        }
        /// <summary>
        ...
        public PathFileSystemLaxParameter(string[] Path)
        {
            ...
            foreach (string entry in Path)
                foreach (string filePath in ResolveFileSystemPath(entry, true, true, false))
                    AddEx(filePath);
        }
        /// <summary>
        ...
        public PathFileSystemLaxParameter(FileInfo File)
        {
            InputObject = File;
            if (!File.Exists)
        ...
        /// <exception cref="ArgumentException"></exception>
        public PathFileSystemLaxParameter(DirectoryInfo Directory)
        {
        ...
        public PathFileSystemLaxParameter(Uri Uri)
        ...
        public PathFileSystemLaxParameter(object Input)
        {
            if (Input == null)
