...
namespace PSFramework.Parameter
{
    ...
    /// </summary>
    public class PublicCertificateParameter
    {
        /// <summary>
        ...
        public PublicCertificateParameter(X509Certificate2 Certificate)
        {
        ...
        /// Will select the longest-lasting valid certificate,
        /// </summary>
        ...
        /// <exception cref="InvalidDataException">Will be thrown when a certificate was found, but it was not valid (expired)</exception>
        public PublicCertificateParameter(string Name)
        {
            ...
            X509Certificate2 certificate = certificates.Where(c => c.NotAfter > DateTime.Now && c.NotBefore < DateTime.Now).OrderBy(c => c.NotAfter.Ticks * -1).First();
            if (null == certificate)
        ...
        public static implicit operator X509Certificate(PublicCertificateParameter Parameter) => Parameter.Certificate;

        /// <summary>
        /// Converts a CertificateParameter into certificate object.
        /// </summary>
        /// <param name="Parameter">The CertificateParameter to convert</param>
        public static implicit operator X509Certificate2(PublicCertificateParameter Parameter) => Parameter.Certificate;

        /// <summary>
        /// Converts a certificate object into a CertificateParameter.
        /// </summary>
        /// <param name="Cert"></param>
        public static implicit operator PublicCertificateParameter(X509Certificate2 Cert) => new PublicCertificateParameter(Cert);
